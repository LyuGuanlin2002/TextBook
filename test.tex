% !TEX program = bibtex
% !Mode:: "TeX:UTF-8"
\documentclass[color=COLORFUL,biblevel=CHAPREF]{textbook-cn}%openany
...
\makeindex[name=video,title=视频索引,columns=3,columnsep=2.0em,options=-s indexstyle.ist]
%%设置英文索引命令%%
...
\lipsum
%\cite{51}\cite{52}\cite{53}\cite{54}\cite{55}
